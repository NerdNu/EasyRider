                ...
                public void onPlayerInteractEntity(PlayerInteractEntityEvent event, SavedHorse savedHorse) {
                    ...
                    if (abstractHorse.getOwner() == null) {
                        ...
                        sender.sendMessage(ChatColor.GOLD + "This " + entityTypeName + ", " +
                                           ...
                                           ", has been freed.");
                        sendingPlayer.playSound(sendingPlayer.getLocation(), SoundCategory.NEUTRAL, Sound.UI_BUTTON_CLICK, 1.0f, 1.0f);
                    } else {
                        sendingPlayer.playSound(sendingPlayer.getLocation(), SoundCategory.NEUTRAL, Sound.ENTITY_ITEM_BREAK, 1.0f, 1.0f);
